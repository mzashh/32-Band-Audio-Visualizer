...
int audio_response = 25;                                      // put a value between 10 and 80. Smaller the number, higher the audio response
...
void setup() {
   // EEPROM.update(1,1);                                         //(memory address, value), UNCOMMENT THIS FOR THE FIRST TIME , used to set the EEPROM to corret bits
